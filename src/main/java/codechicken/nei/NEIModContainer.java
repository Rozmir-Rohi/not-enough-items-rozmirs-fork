...
public class NEIModContainer extends DummyModContainer
{
    ...
    private void loadMetadata() {
        description = super.getMetadata().description.replace("Supporters of Original Mod:", EnumChatFormatting.AQUA+"Supporters of Original Mod:");
    }
    ...
    public ModMetadata getMetadata() {
        ...
        if (plugins.size() == 0) {
            s_plugins.append("No installed plugins.");
        } else {
